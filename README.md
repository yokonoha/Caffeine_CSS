...
個人のサイトのみならず、**子育て支援のサイト**や**福祉・介護のサイト**、**イベント系のサイト**など、安心感・親しみを与えたいサイトの製作にもご活用いただけます。  
************************************
## NEWNEWNEW!!!!  
ダーク基調のCSS、FSLinearをさらに改良した新CSS,FSOVerrideが公開されてます!  
テーマは変わりますが、安定性がありるのでこっちのが断然おススメです!もちろん無料です。  
https://github.com/yokonoha/fsoverride  
HTML,CSS...あー!わからない!何か楽してサイトが作りたい!という方はコチラをどうぞ。(一般公開テスト中)  
https://fswrite.pages.dev  

## New！  
クールなサイトがすぐ作れる！ダーク基調のCSS、FSLinearが公開されました。こちらも合わせてご利用いただけます。
https://github.com/yokonoha/FSLinear  

## New!
FSLinear(黒基調の互換CSS)と同時に使用できるスクリプトが公開されました!  
...
CaffeineCSSはMITライセンス(オープンソースライセンス)とAライセンス(独自ライセンス)のマルチライセンス体系を採用しています。  
...
- **MITライセンス** 
    ...
    - 様式に基づいた権利表記が必要  
    - 正式かつフォーマルな条文
- [**Aライセンス**](https://yokonoha.github.io/alicense)  
    - 主に横茶横葉が製作した成果物に付加される独自互換ライセンス  
    - 条件は緩く、商用利用が可能   
    - 権利表記は端的に記載しても問題なし
...
製作者より: 色々複雑なライセンス体系となってしまい、申し訳ございません。長々と書いてしまいましたが、あまり難しく考えたくない方はAライセンスを適用してご利用ください。footerの権利表記文のみで大体は条件を満たしたことになります!(できる限り記載していただきたいですが、やむを得ない場合は書かなくても指摘はしません!) 横茶横葉のライセンスは初心者でもリスクなしで安心して利用できるようにするために設定されています!  
